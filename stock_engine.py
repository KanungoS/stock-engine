...
for symbol in stocks:
    try:
        ...
        # Append rows
        df_fund.append([symbol, latest, return_1D, return_1W, return_1M, return_3M, return_6M, return_1Y])
        df_tech.append([symbol, rsi_val, macd_latest, macd_1d, signal_latest, signal_1d, histogram_trend, ema20, ema50, ema100, price_20, price_50, price_100])
        df_vol.append([symbol, weekly_stddev, weekly_atr, weekly_wow, trend_13w])
...
pd.DataFrame(df_fund, columns=[
    "Symbol","Latest_Close","Return_1D","Return_1W","Return_1M","Return_3M","Return_6M","Return_1Y"
]).to_csv("output/fundamentals.csv", index=False)

pd.DataFrame(df_tech, columns=[
    "Symbol","RSI","MACD_Latest","MACD_1D","Signal_Latest","Signal_1D","Histogram_Trend",
    "EMA20","EMA50","EMA100","Price_20","Price_50","Price_100"
...
print("All 3 sheets generated successfully!")
