...
# -------------------------------------------------------
# Robust NSE Data Fetcher (solves empty CSV issue)
# -------------------------------------------------------
def fetch_data(symbol):
    ...
    # Method 2 — Ticker history (very reliable)
    try:
    ...
    # Method 3 — Force specific parameters
    try:
        df = yf.download(
            symbol,
            interval="1d",
    ...
    return pd.DataFrame()  # fail-safe empty dataframe
...
pd.DataFrame(df_fund, columns=[
    "Symbol","Latest_Close","Return_1D","Return_1W","Return_1M",
...
print("\n🎉 SUCCESS — All files generated with DATA!\n")
