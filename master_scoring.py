...
def process(sym):
    try:
        ...
        out["long_term"] = np.nanmean([
            out["change_2y"], out["change_3y"], out["change_4y"], out["change_5y"]
        ])
...
def run_engine():
    ...
    # Rank
    master["Rank"] = master["combined_score"].rank(ascending=False, method="dense").astype(int)
    ...
    with pd.ExcelWriter(outfile, engine="openpyxl") as writer:
        ...
        # Short / Medium / Long / Top 20 sheets
