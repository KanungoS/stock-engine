...
# Silence all warnings from pandas, yfinance, numpy, etc.
...
def download_data(symbol):
    """
    Download data silently, with retry, caching, and no console output.
    Ensures GitHub Actions logs do not exceed limits.
    """
    ...
    return None  # Silent fail, stock skipped
